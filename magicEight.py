...
normalAnswers = ["It is certain", "It is decidedly so", "Without a doubt", "Yes definitely", "You may rely on it", "As I see it, yes", 
...
input()
wiseResponse = random.choice(normalAnswers)
print()
print(wiseResponse)
print()
